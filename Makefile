...
$(BUILD_DIR)/$(DECK).pdf: $(DECK).tex Quantum-Fair-Exchange/references.bib | $(BUILD_DIR)
	$(LATEXMK) $(LATEXMK_FLAGS) $(DECK).tex

$(BUILD_DIR)/$(NOTES).pdf: $(NOTES).tex $(DECK).tex Quantum-Fair-Exchange/references.bib | $(BUILD_DIR)
